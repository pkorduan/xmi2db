					...
					<div class="container">
						...
						<i>Das Schema wird entsprechend der gewählten Konfiguration in der Datenbank
							...
							<i>Das Schema wird entsprechend der gewählten Konfiguration in der Datenbank
								...
								Listen
								<ul>
									<li><a href="listAttributes.php">Attribute</a></li>
									<li><a href="listComplexTypes.php">komplexe Typen</a></li>
									<li><a href="umbenennungsliste.php">Liste der Umbenennungen von Attributen</a></li>
								</ul>
							</div>
						</body>
						</html>
